...
def main():
    ...
    print("=" * 80)
    print("\nNext steps:")
    print(f"1. Train TTS with RL (LightningCLI):")
    print(f"   python -m tspeech.tts fit --config config/tts-rl.json \\")
    print(f"       --data.dataset_dir {args.output_dir} \\")
    print(f"       --data.csv_train {args.output_dir}/train.csv \\")
    print(f"       --data.csv_val {args.output_dir}/val.csv \\")
    print(f"       --model.hubert_checkpoint_path <path_to_hubert.ckpt>")
